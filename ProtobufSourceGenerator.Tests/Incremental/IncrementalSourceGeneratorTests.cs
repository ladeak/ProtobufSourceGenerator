...
public partial class Entity
{
    ...
    [Fact]
    public async Task IDictionary_GenerateIsEmptyProperty()
    {
        var code = @"namespace Test;
[ProtoBuf.ProtoContract]
public partial class Entity
{
    public System.Collections.Generic.IDictionary<int, string> Id { get; set; }
}";
...
{
    [global::ProtoBuf.ProtoMember(1)]
    private System.Collections.Generic.IDictionary<int, string> ProtoId { get => Id; set => Id = value; }
    ...
    private bool ProtoIsEmptyId
    {
        ...
        {
            if (value)
                ProtoId = new global::System.Collections.Generic.Dictionary<int, string>();
        }
    }
}";
    ...
    [Fact]
    public async Task GeneratorOptions_PropertyAttributes()
    {
        var code = @"namespace Test;
[ProtoBuf.ProtoContract]
[ProtobufSourceGenerator.GeneratorOptions(PropertyAttributeType = typeof(System.ObsoleteAttribute))]
public partial class Entity
{
    public int Id { get; set; }
}";
