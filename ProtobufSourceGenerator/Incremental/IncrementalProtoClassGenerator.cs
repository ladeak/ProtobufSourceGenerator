...
internal sealed class IncrementalProtoClassGenerator
{
    public string CreateClass(ProtoClassDataModel classModel)
    {
        ...
        foreach (ProtoPropertyDataModel property in classModel.PropertyDataModels)
        {
            ...
            var protoAttributes = SyntaxFactory.SingletonList(
            ...
            if (!string.IsNullOrEmpty(property.CustomAttribute))
                protoAttributes = protoAttributes.Add(CreateCustomAttribute(property.CustomAttribute));
            ...
            newProperty = newProperty.WithAccessorList(SyntaxFactory.AccessorList(SyntaxFactory.List(new[] { getter, setter })))
                ...
                .WithAttributeLists(protoAttributes);
    ...
    private AttributeListSyntax CreateCustomAttribute(string fullName)
    {
        return SyntaxFactory.AttributeList(SyntaxFactory.SingletonSeparatedList(SyntaxFactory.Attribute(
                SyntaxFactory.ParseName("global::" + fullName))));
    }
